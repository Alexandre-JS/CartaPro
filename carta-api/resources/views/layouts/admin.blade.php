...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        ...
        @if(auth()->user()->isAdmin())
            <nav class="nav"><a class="{{ request()->routeIs('admin.amostra.*') ? 'active' : '' }}" href="{{ route('admin.amostra.index') }}"><svg viewBox="0 0 24 24"><path d="M7 11V7a5 5 0 0 1 9.9-1M5 11h14v10H5z"/></svg>Amostra gratuita</a><a class="{{ request()->routeIs('admin.publications.*') ? 'active' : '' }}" href="{{ route('admin.publications.index') }}"><svg viewBox="0 0 24 24"><path d="M12 3v12M7 8l5-5 5 5M5 14v6h14v-6"/></svg>Publicação</a></nav>
